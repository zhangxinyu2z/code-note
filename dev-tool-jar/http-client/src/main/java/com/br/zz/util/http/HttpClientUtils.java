...
/*
 * ArrrowCtrl Inc., All rights reserved. 2016.
...
public class HttpClientUtils {
        ...
        try {
            if (paras != null) {
                for (Entry<String, String> entry : paras.entrySet()) {
                    query = query + URLEncoder.encode(entry.getKey(), reqCharset.name()) + "="
                        + URLEncoder.encode(entry.getValue(), reqCharset.name()) + "&";
                }
            }
     ...
     * @return
     */
    public static byte[] post(String url, Map<String, String> paras, Charset reqCharset) {
        Form form = Form.form();
        byte[] bytes = null;
        try {
            if (paras != null) {
     ...
     * @return
     */
    public static String post(String url, Map<String, String> paras, Charset reqCharset, Charset resCharset) {
        return new String(post(url, paras, reqCharset), resCharset);
    }
...
class MyFileBody extends AbstractContentBody {
