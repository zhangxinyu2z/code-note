...
import com.wk.xin.util.UnicodeUtil;
import com.wk.xin.util.http.HttpClientUtil;
import com.wk.xin.util.http.HttpConstant;
import com.wk.xin.util.http.OkHttpClientUtils;
import lombok.Data;
 ...
 */
public class TungeeThirdApiTest {
    ...
    /**
     * 调用探迹（提供类似天眼查的功能）的第三方API，查询公司的相关信息
     */
    @Test
     ...
     * @param type 模糊搜索传1，其他传2  实际根据对接文档
     * @return
     */
    private String requestThirdApi(String searchUrl, String keyword, Integer type) {
        ...
        return UnicodeUtil.unicodeDecode(resJson);
    }
